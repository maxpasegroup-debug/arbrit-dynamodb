...
login_response = requests.post("https://safety-docs-hub.preview.emergentagent.com/api/auth/login", 
...
if login_response.status_code == 200:
    ...
    response = requests.post("https://safety-docs-hub.preview.emergentagent.com/api/sales/invoice-requests", 
