...
login_response = requests.post("https://crm-safety-app.preview.emergentagent.com/api/auth/login", 
...
if login_response.status_code == 200:
    ...
    response = requests.post("https://crm-safety-app.preview.emergentagent.com/api/sales/invoice-requests", 
