...
class DB:
    ...
    def __init__(self):
        ...
        # Stub clients for tables that don't exist yet (return empty results)
        ...
        self.assessment_forms = StubDynamoDBClient('assessment_forms')
        self.assessment_submissions = StubDynamoDBClient('assessment_submissions')
        self.audit_logs = StubDynamoDBClient('audit_logs')
        self.certificate_requests = StubDynamoDBClient('certificate_requests')
        self.certificate_templates = StubDynamoDBClient('certificate_templates')
        self.client_accounts = StubDynamoDBClient('client_accounts')
        self.credit_notes = StubDynamoDBClient('credit_notes')
        self.invoice_requests = StubDynamoDBClient('invoice_requests')
        self.payments = StubDynamoDBClient('payments')
        self.petty_cash = StubDynamoDBClient('petty_cash')
        self.recurring_invoices = StubDynamoDBClient('recurring_invoices')
        self.training_sessions = StubDynamoDBClient('training_sessions')
        self.vendor_payments = StubDynamoDBClient('vendor_payments')
        self.vendors = StubDynamoDBClient('vendors')
