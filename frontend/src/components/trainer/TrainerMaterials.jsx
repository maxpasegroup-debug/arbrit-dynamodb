                  ...
                  <div
                    ...
                    className={`${
                      selectedFolder?.id === folder.id
                        ...
                        : 'bg-white border border-white/10 text-slate-300'
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <Badge className="bg-slate-900 text-white border-white/20 text-xs">
                                  {doc.document_type}
                                </Badge>
                              </div>
                                ...
                                {doc.tags && doc.tags.length > 0 && (
                                  <div className="flex gap-1">
                                    {doc.tags.slice(0, 3).map((tag, idx) => (
                                      <span key={idx} className="px-2 py-0.5 bg-slate-900 rounded text-slate-400">
                                        {tag}
                                      </span>
                                    ))}
                                  </div>
