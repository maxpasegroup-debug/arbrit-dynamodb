...
const TrainingLibrary = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="bg-slate-900 text-blue-600 hover:bg-blue-50"
            >
      ...
      {/* Search and Filters */}
      <div className="bg-slate-900 backdrop-blur-sm rounded-xl border border-white/10 p-4">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredRecords.map((record) => (
              <div
                key={record.id}
                className="bg-slate-900 border border-white/10 rounded-lg p-4 hover:bg-white transition-all cursor-pointer"
          ...
          <div className="space-y-2">
            {filteredRecords.map((record) => (
              <div
                key={record.id}
                className="bg-slate-900 border border-white/10 rounded-lg p-4 hover:bg-white transition-all cursor-pointer flex items-center justify-between"
                onClick={() => handleViewDetails(record)}
              >
