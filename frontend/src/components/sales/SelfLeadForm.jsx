              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-gray-300 text-gray-900 rounded-md p-2 mt-1"
                  >
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-gray-300 text-gray-900 rounded-md p-2 mt-1 min-h-[80px]"
