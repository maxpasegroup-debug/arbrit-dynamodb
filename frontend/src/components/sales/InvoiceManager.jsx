          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {formData.payment_terms === 'Partial' && (
              <div>
                ...
                <Input type="number" value={formData.initial_amount} onChange={(e) => setFormData({...formData, initial_amount: e.target.value})} className="bg-white/5 border-white/20 text-white mt-1" />
              </div>
            )}
            <div>
