...
import { Package, Plus, Eye, Upload, Camera, CheckCircle, Clock, Truck, AlertTriangle, AlertCircle } from 'lucide-react';
...
import AgingAlertsButton from './AgingAlertsButton';
          ...
          <button
            ...
            className={`py-2 px-4 rounded-lg font-semibold transition-all ${
              filterCategory === 'all'
                ...
                : 'bg-transparent text-slate-400 hover:text-white hover:bg-white'
            }`}
          >
            📋 All Certificates
