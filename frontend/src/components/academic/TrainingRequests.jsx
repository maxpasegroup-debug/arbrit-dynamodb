            ...
            <div className="space-y-4">
              ...
              {(actionType === 'approve' || actionType === 'assign') && (
                <div>
                  ...
                  <Input value={formData.confirmed_slots} onChange={(e) => setFormData({...formData, confirmed_slots: e.target.value})} className="bg-white/5 border-white/20 text-white mt-1" />
                </div>
              )}
              ...
              {actionType === 'alternative' && (
                <div>
                  ...
                  <Input value={formData.alternative_dates} onChange={(e) => setFormData({...formData, alternative_dates: e.target.value})} className="bg-white/5 border-white/20 text-white mt-1" />
                </div>
              )}

              <div>
                <Label className="text-gray-300">Remarks</Label>
                <Textarea value={formData.remarks} onChange={(e) => setFormData({...formData, remarks: e.target.value})} rows={3} className="bg-white/5 border-white/20 text-white mt-1" />
              </div>
            </div>
          )}
          <DialogFooter>
