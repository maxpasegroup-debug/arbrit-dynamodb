...
const EmployeeManagement = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Filters */}
      <div className="bg-slate-900 backdrop-blur-sm rounded-xl border border-white/10 p-4 mb-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <Select value={filterDepartment} onValueChange={setFilterDepartment}>
              <SelectTrigger data-testid="filter-department" className="bg-slate-900 border-white/20 text-white">
          ...
          <div className="flex items-end">
            {(filterBranch || filterDepartment) && (
              <Button
                ...
                variant="outline"
                className="border-white/20 text-white hover:bg-white w-full"
              >
                Clear Filters
              </Button>
            )}
      ...
      <div className="flex items-center justify-between">
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            ...
            className="pl-10 bg-slate-900 border-white/20 text-white placeholder:text-gray-400"
          />
        </div>
        <Button
            ...
            {loading && employees.length === 0 ? (
              ...
              sortedDepartments.map(department => (
                <>
                  ...
                  <TableRow key={`dept-${department}`} className="bg-slate-900 border-white/20">
                  ...
                  {groupedEmployees[department].map((employee) => (
                    <TableRow key={employee.id} className="border-white/10 hover:bg-white" data-testid={`employee-row-${employee.id}`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Select value={formData.branch} onValueChange={(value) => setFormData({ ...formData, branch: value })}>
                <SelectTrigger data-testid="employee-branch-select" className="bg-slate-900 border-white/20 text-white mt-1">
            ...
            <div>
              ...
              >
                <SelectTrigger data-testid="employee-department-select" className="bg-slate-900 border-white/20 text-white mt-1">
            ...
            <div>
              ...
              >
                <SelectTrigger data-testid="employee-designation-select" className="bg-slate-900 border-white/20 text-white mt-1">
              ...
              <>
                <div>
                  ...
                  <Select value={formData.sales_type} onValueChange={(value) => setFormData({ ...formData, sales_type: value })}>
                    <SelectTrigger data-testid="employee-salestype-select" className="bg-slate-900 border-white/20 text-white mt-1">
                ...
                <div>
                  ...
                  <Select value={formData.badge_title} onValueChange={(value) => setFormData({ ...formData, badge_title: value })}>
                    <SelectTrigger data-testid="employee-badge-select" className="bg-slate-900 border-white/20 text-white mt-1">
