        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex-1 max-w-md">
            ...
            <Select value={selectedEmployee} onValueChange={handleEmployeeChange}>
              <SelectTrigger data-testid="employee-select" className="bg-white/5 border-white/20 text-white">
          ...
          <form onSubmit={handleUpload} className="space-y-4">
            <div>
              ...
              <Select value={formData.doc_type} onValueChange={(value) => setFormData({ ...formData, doc_type: value })}>
                <SelectTrigger data-testid="doc-type-select" className="bg-white/5 border-white/20 text-white mt-1">
